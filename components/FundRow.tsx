...
const FundRow: React.FC<Props> = ({ fund, onToggle }) => {
  ...
  return (
    <div className="flex items-center py-3 px-2 bg-white border-b border-gray-100 text-sm hover:bg-gray-50 transition-colors">
      {/* Column 1: Name & Code */}
      <div className="w-[33%] sm:w-[30%] flex flex-col justify-center overflow-hidden">
      ...
      {/* Column 2: Valuation */}
      <div className="w-[33%] sm:w-[30%] flex flex-col items-center justify-center text-center">

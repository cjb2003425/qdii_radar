  ...
  return (
    <div className="space-y-2 px-3">
      ...
      <div className="bg-white rounded-xl shadow-md border border-gray-200 overflow-hidden">
        ...
        <div className="bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 px-3 py-1.5">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-1.5">
              ...
              <div>
                <h2 className="text-[11px] sm:text-sm font-bold text-white">
                  监控控制
                </h2>
              </div>
            </div>
            <div className={`px-1.5 py-0.5 rounded-full flex items-center space-x-1 shadow-md backdrop-blur-sm ${
              status.is_running
              ...
              <div className="relative p-2">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-1.5">
                    ...
                    <div>
                      <h3 className="text-[11px] font-semibold text-gray-900">基金监控</h3>
              ...
              <div className="relative p-2">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-1.5">
                    ...
                    <div>
                      <h3 className="text-[11px] font-semibold text-gray-900">提醒时间</h3>
                      <p className="text-[10px] text-gray-500">
              ...
              <div className="relative p-2">
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-1.5">
                    ...
                    <div>
                      <h3 className="text-[11px] font-semibold text-gray-900">检查间隔</h3>
                      <p className="text-[10px] text-gray-500">
                        {intervalMinutes} 分钟
                      </p>
                    </div>
                  ...
                  <select
                    ...
                    className={`text-[11px] font-medium rounded-lg border-2 bg-white px-1.5 py-1 focus:outline-none focus:ring-2 transition-all ${
                      updatingInterval
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-[auto_auto_auto_minmax(120px,1fr)_minmax(120px,1fr)] gap-1 sm:gap-2">
        {/* Monitor Status */}
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 px-1.5 py-1.5">
          <div className="flex items-center space-x-1">
            ...
            <div className="min-w-0">
              <p className="text-[8px] text-gray-500">监控</p>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 px-1.5 py-1.5">
          <div className="flex items-center space-x-1">
            ...
            <div className="min-w-0">
              <p className="text-[8px] text-gray-500">状态</p>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 px-1.5 py-1.5">
          <div className="flex items-center space-x-1">
            ...
            <div className="min-w-0">
              <p className="text-[8px] text-gray-500">间隔</p>
        ...
        <div className="md:hidden col-span-2 bg-white rounded-lg shadow-sm border border-gray-200 p-1.5">
          <div className="grid grid-cols-2 gap-1.5">
            <div className="flex items-center space-x-1">
              ...
              <div className="min-w-0">
                <p className="text-[8px] text-gray-500">上次检查</p>
            ...
            <div className="flex items-center space-x-1">
              ...
              <div className="min-w-0">
                <p className="text-[8px] text-gray-500">上次邮件</p>
                <p className="text-[10px] font-semibold text-gray-900 truncate">
